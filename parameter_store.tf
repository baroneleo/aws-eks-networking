...
resource "aws_ssm_parameter" "private_subnets" {
  ...
  name = "/${var.project_name}/subnets/public/${var.private_subnets[count.index].availability_zone}/${var.private_subnets[count.index].name}"
  type = "String"
...
resource "aws_ssm_parameter" "databases_subnets" {
  ...
  name = "/${var.project_name}/subnets/public/${var.database_subnets[count.index].availability_zone}/${var.database_subnets[count.index].name}"
  type = "String"
